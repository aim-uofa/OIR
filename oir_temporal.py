...
from sampler.oir_denoise import candidate_images_generation
...
def main(args):
    ...
    candidate_images = candidate_images_generation(
        ldm_stable, 
        prompts, 
...
############################################################################################################################################
    # 4. crop the image and save it for easily visualization
...
########################################################################################################################
    ...
    #     )
    #     sweet_results[prompt_changes[p_idx]] = max_idx
